...
const LocationsGrid = ({ serviceSlug, serviceName }: LocationsGridProps) => {
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {sortedLocations.map((location) => (
            <Link
              ...
              className="group bg-white rounded-xl p-5 hover:bg-sky-50 transition-all duration-300 border border-slate-200 hover:border-sky-300 hover:shadow-md"
            >
